...
type SubRuleGeneratorInterface interface {
	...
	GenerateSubShardingRuleWithTimeWithPb(cfg *trconfpb.ShardingWithTimeConfig) (SubRuleWithTime, error)
...
type TimeNodeQueryInterface interface {
	...
	GetDefaultCronExpressionGenerator() gscron.ExpressionGenerator
}
